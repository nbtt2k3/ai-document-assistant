...
class PromptManager:
    @staticmethod
    def get_langchain_messages(prompt_type: str, model_name: str) -> list[tuple[str, str]]:
        """
        ...
        # If the model_name doesn't contain 'llama', we still fallback to llama for now.
